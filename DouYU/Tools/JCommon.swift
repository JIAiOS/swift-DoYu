...
let J_DOUYU_TOKEN : String = "J_DOUYU_TOKEN"
let KscreenWidth  = UIScreen.main.bounds.size.width
let KscreenHeight = UIScreen.main.bounds.size.height

//判断是否为iPhoneX
let is_iPhoneX = KscreenHeight >= 812 ? true : false
//状态栏高度
let KstatusHeight : CGFloat = is_iPhoneX ? 44 : 20
//导航栏高度
let KnavgationBarHeight : CGFloat = 44
//tabbar高度
let KtabBarHeight : CGFloat = is_iPhoneX ? 49 + 34 : 49
let CateItemHeight = KscreenWidth / 4
let KcateTitleHeight : CGFloat = 42
...
func setUpGradientLayer(view : UIView , frame : CGRect , color : [CGColor], corneradiu : CGFloat? = 0){
