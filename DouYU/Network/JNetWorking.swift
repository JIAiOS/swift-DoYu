...
class JNetWorking {
    ...
    class func requestData(type : JMethod, URlString: String, parameters : [String : Any]? = nil,  finishCallBack : @escaping (_ responseCall : Data)->()){
        
        let type = type == JMethod.GET ? HTTPMethod.get : HTTPMethod.post
        // 配置 HTTPHeaders
